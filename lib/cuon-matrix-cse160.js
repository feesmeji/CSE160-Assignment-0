...
class Vector3 {
    ...
    /**
      ...
      * @return scalar
      * my implementation inspired by :https://stackoverflow.com/questions/64816766/dot-product-of-two-arrays-in-javascript
      */
    ...
    /**
      ...
      * @return new vector
      * Cross Product = https://www.youtube.com/watch?v=-n_C7tD55_A
      */
    ...
    magnitude() {
        ...
        let m = Math.sqrt((x ** 2) + (y ** 2) + (z ** 2)); // Modify this line to calculate this vector's magnitude.
        // Don't delete the return statement.
    ...
    normalize() {
        ...
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        let magnitude = this.magnitude() //chat gpt helped me fix this line, I originally just had magnitude = magnitude()
